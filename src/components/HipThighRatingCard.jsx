      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden border-l-4 border-amber-500">
        ...
        {expanded && (
            <div className="px-6 pb-6 space-y-6">
              ...
              <div>
                <h4 className="font-medium text-gray-900 dark:text-white mb-2 text-center">
                  VA Rating Schedule - Hip and Thigh
                </h4>
                    ...
                    return (
                        <div
                            ...
                            className={`p-3 rounded-lg border ${
                                isSupported ? 'border-2' : ''
                            } ${getRatingRowColor(rating.percent, isSupported)}`}
                        >
                          <div className="flex items-center gap-3">
                            <div className={`w-14 text-center font-bold flex-shrink-0 ${
                                isSupported
              ...
              <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg border border-amber-200 dark:border-amber-800">
                <h4 className="font-semibold text-amber-900 dark:text-amber-200 mb-2 flex items-center gap-2">
                  <span>📋</span>
                  Multiple Hip Ratings Possible
                </h4>
                <p className="text-sm text-amber-800 dark:text-amber-300">
                  <strong>Note:</strong> If the hip is limited in flexion, extension AND abduction,
                  it can be rated three times. Include flare-ups in your claim with date, duration,
                  and other symptoms. Document interference with work, social activities including family,
                  and quality of life.
                </p>
              </div>
