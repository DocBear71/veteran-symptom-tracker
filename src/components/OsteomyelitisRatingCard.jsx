 ...
 * 38 CFR 4.71a - Has its own unique rating schedule
 */
export default function OsteomyelitisRatingCard({ analysis, expanded, onToggle }) {
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden border-l-4 border-amber-500">
        ...
        {expanded && (
            <div className="px-6 pb-6 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  ...
                  <div className={`p-3 rounded-lg text-center ${
                    ...
                    <div className="text-xs text-gray-600 dark:text-gray-400">Bone Pain</div>
                  </div>
                  <div className={`p-3 rounded-lg text-center ${
                      metrics?.drainingSinus > 0 ? 'bg-purple-50 dark:bg-purple-900/20' : 'bg-gray-50 dark:bg-gray-700/30'
                  }`}>
                    <div className={`text-2xl font-bold ${
                        metrics?.drainingSinus > 0 ? 'text-purple-600 dark:text-purple-400' : 'text-gray-400'
                    }`}>
                      {metrics?.drainingSinus || 0}
                    </div>
                    <div className="text-xs text-gray-600 dark:text-gray-400">Drainage</div>
                  </div>
                  <div className={`p-3 rounded-lg text-center ${
                    ...
                    <div className="text-xs text-gray-600 dark:text-gray-400">Active Episodes</div>
                  </div>
                </div>
              </div>
              ...
              {/* Osteomyelitis-Specific Information */}
              <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg border border-amber-200 dark:border-amber-800">
                <h4 className="font-semibold text-amber-900 dark:text-amber-200 mb-2 flex items-center gap-2">
                  <span>ℹ️</span>
                  Osteomyelitis Key Terms
                </h4>
                <ul className="space-y-1">
                  <li className="text-sm text-amber-800 dark:text-amber-300 flex items-start gap-2">
                    <span className="text-amber-500 mt-0.5">•</span>
                    <span><strong>Involucrum:</strong> New bone shell forming around dead bone</span>
                  </li>
                  <li className="text-sm text-amber-800 dark:text-amber-300 flex items-start gap-2">
                    <span className="text-amber-500 mt-0.5">•</span>
                    <span><strong>Sequestrum:</strong> Dead bone fragment that separated from healthy bone</span>
                  </li>
                  <li className="text-sm text-amber-800 dark:text-amber-300 flex items-start gap-2">
                    <span className="text-amber-500 mt-0.5">•</span>
                    <span><strong>Discharging Sinus:</strong> Tract draining pus from infected bone</span>
                  </li>
                  <li className="text-sm text-amber-800 dark:text-amber-300 flex items-start gap-2">
                    <span className="text-amber-500 mt-0.5">•</span>
                    <span><strong>Constitutional:</strong> Systemic symptoms (fever, fatigue, weight loss)</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg border border-red-200 dark:border-red-800">
                ...
                <ul className="space-y-1">
                  <li className="text-sm text-red-800 dark:text-red-300 flex items-start gap-2">
                    ...
                    <span>100% requires pelvis/vertebrae, major joints, multiple sites, or long history with constitutional symptoms</span>
                  </li>
                  <li className="text-sm text-red-800 dark:text-red-300 flex items-start gap-2">
                    <span className="text-red-500 mt-0.5">•</span>
                    <span>20% requires recurrent osteomyelitis (2+ episodes after initial)</span>
                  </li>
                  <li className="text-sm text-red-800 dark:text-red-300 flex items-start gap-2">
                    <span className="text-red-500 mt-0.5">•</span>
                    <span>Rating NOT applied following cure by removal/resection of affected bone</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-gray-100 dark:bg-gray-700/50 rounded-lg p-3 text-xs text-gray-600 dark:text-gray-400">
                <strong>Important:</strong> {criteria?.disclaimer || 'Osteomyelitis (DC 5000) has its own rating schedule. Document infection episodes, imaging findings, and any draining wounds. For documentation purposes only.'}
              </div>
            </div>
        )}
      </div>
