                ...
                <div>
                    {medications.length === 0 ? (
                        ...
                        <div className="space-y-2">
                            <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">Tap to log that you took it:</p>
                            {medications.filter(m => m.isActive).map((med) => (
                                <button
                                    key={med.id}
                                    onClick={() => handleQuickLog(med)}
                                    className="w-full bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 text-left hover:border-blue-400 dark:hover:border-blue-500 hover:shadow-sm transition-all"
                                >
                                ...
                                >
                                    <div className="flex justify-between items-start">
                                        <div>
                                            ...
                                            {med.notes && (
                                                <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">{med.notes}</p>
                                            )}
                                        </div>
                                        <button
                                ...
                                >
                                    <div className="flex justify-between items-start">
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600 dark:text-gray-400">{log.dosage}</p>
                                            <p className="text-xs text-gray-400 dark:text-gray-500">{formatDate(log.timestamp)}</p>
                                            {log.takenFor && (
                                                <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">For: {log.takenFor}</p>
                                            )}
                                            {log.notes && (
                                                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 bg-gray-50 dark:bg-gray-700 p-2 rounded">
                                                    {log.notes}
                                                </p>
                                            )}
                                        </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg w-full max-w-md max-h-[90vh] overflow-y-auto">
                        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
                            <div className="flex justify-between items-center">
                                ...
                                <button onClick={() => setShowAddForm(false)} className="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 text-xl">
                                    ✕
                                </button>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleAddMedication} className="p-4 space-y-4">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    type="submit"
                                    className="flex-1 py-3 px-4 bg-blue-900 dark:bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-800 dark:hover:bg-blue-700"
                                >
                                    Add Medication
                                </button>
                            </div>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white dark:bg-gray-800 rounded-lg w-full max-w-md">
                        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
                            <div className="flex justify-between items-center">
                                <div>
                                    <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Log Medication</h2>
                                    <p className="text-sm text-gray-500 dark:text-gray-400">{selectedMed.name} - {selectedMed.dosage}</p>
                                </div>
                                <button onClick={() => { setShowLogForm(false); setSelectedMed(null); }} className="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 text-xl">
                                    ✕
                                </button>
                            </div>
                        </div>
