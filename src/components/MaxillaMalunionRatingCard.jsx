...
/**
 * Maxilla Malunion/Nonunion Rating Card Component
 * Shows maxilla fracture healing analysis and VA rating (DC 9916)
 * Note: Uses same criteria as mandible (DC 9903-9904)
 */
const MaxillaMalunionRatingCard = ({ analysis, expanded, onToggle }) => {
          ...
          <div className="flex items-center gap-3">
            {supportedRating && (
                <span className={`px-3 py-1 rounded-full text-sm font-medium border ${
                    supportedRating.includes('-') || supportedRating.includes('Requires')
              ...
              <div className="space-y-4 text-left">
                ...
                {criteria.definitions && Object.keys(criteria.definitions).length > 0 && (
                    <div>
                      ...
                      >
                        <span>📖</span>
                        <span>{showDefinitions ? 'Hide' : 'Show'} Maxilla Fracture Definitions</span>
                      </button>
                ...
                <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-4 border-l-4 border-amber-500">
                  <h4 className="font-medium text-amber-900 dark:text-amber-300 mb-2">
                    Important: Maxilla (Upper Jaw) Fracture Documentation
                  </h4>
                  <ul className="space-y-2 text-sm text-amber-800 dark:text-amber-400">
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>X-rays or CT scans showing nonunion or malunion are critical</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Document facial deformity, bite problems (malocclusion), and chewing difficulty</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Maxilla fractures may affect sinuses - document sinus symptoms if present</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Track pain with eating, speaking, and facial pressure</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Surgical records from fracture repair are important evidence</span>
                    </li>
                  </ul>
                </div>
...
export default MaxillaMalunionRatingCard;