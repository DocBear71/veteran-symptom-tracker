...
import { DIABETES_INSIPIDUS_CRITERIA } from '../utils/ratingCriteria';
 ...
 */
export default function DiabetesInsipidusRatingCard({ analysis, expanded, onToggle }) {
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              <h3 className="font-semibold text-lg text-gray-900 dark:text-white">Diabetes Insipidus</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">DC 7909 - 38 CFR 4.119</p>
            </div>
          </div>
            ...
            <div className="px-6 pb-6 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  ...
                  <div className={`p-3 rounded-lg text-center ${metrics?.polyuriaLogs > 0 ? 'bg-cyan-50 dark:bg-cyan-900/20' : 'bg-gray-50 dark:bg-gray-700/30'}`}>
                    <div className={`text-2xl font-bold ${metrics?.polyuriaLogs > 0 ? 'text-cyan-600 dark:text-cyan-400' : 'text-gray-400'}`}>
                      {metrics?.polyuriaLogs || 0}
                    </div>
                    <div className="text-xs text-gray-600 dark:text-gray-400">Polyuria</div>
                  </div>
                  <div className={`p-3 rounded-lg text-center ${metrics?.polydipsiaLogs > 0 ? 'bg-teal-50 dark:bg-teal-900/20' : 'bg-gray-50 dark:bg-gray-700/30'}`}>
                    <div className={`text-2xl font-bold ${metrics?.polydipsiaLogs > 0 ? 'text-teal-600 dark:text-teal-400' : 'text-gray-400'}`}>
                      {metrics?.polydipsiaLogs || 0}
                    </div>
                    <div className="text-xs text-gray-600 dark:text-gray-400">Polydipsia</div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className={`p-3 rounded-lg text-center ${metrics?.hasPersistentPolyuria ? 'bg-amber-50 dark:bg-amber-900/20 border border-amber-300 dark:border-amber-700' : 'bg-gray-50 dark:bg-gray-700/30'}`}>
                    <div className={`text-xl ${metrics?.hasPersistentPolyuria ? 'text-amber-600 dark:text-amber-400' : 'text-gray-400'}`}>
                      {metrics?.hasPersistentPolyuria ? '✓ Persistent' : '○ Not Established'}
                    </div>
                    <div className="text-xs text-gray-600 dark:text-gray-400">Polyuria Status</div>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700/30 p-3 rounded-lg text-center">
                    <div className="text-xl font-semibold text-gray-700 dark:text-gray-300">{metrics?.dehydrationLogs || 0}</div>
                    <div className="text-xs text-gray-600 dark:text-gray-400">Dehydration Symptoms</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                ...
                <ul className="space-y-1">
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2">
                    ...
                    <span>30% rating for 3 months after initial diagnosis</span>
                  </li>
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2">
                    <span className="text-blue-500 mt-0.5">•</span>
                    <span>After 3 months: 10% if persistent polyuria or continuous therapy</span>
                  </li>
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2">
                    <span className="text-blue-500 mt-0.5">•</span>
                    <span>If condition subsides, rate residuals under appropriate codes</span>
                  </li>
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2">
                    <span className="text-blue-500 mt-0.5">•</span>
                    <span>Common treatment: desmopressin (DDAVP)</span>
                  </li>
                </ul>
              </div>
