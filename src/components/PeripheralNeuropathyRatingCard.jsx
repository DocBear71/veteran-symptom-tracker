...
/**
 * Peripheral Neuropathy Rating Card Component
 * Shows peripheral neuropathy symptom analysis and VA rating
 */
const PeripheralNeuropathyRatingCard = ({ analysis, expanded, onToggle }) => {
              ...
              <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    {criteria.ratings.map(rating => {
                      const isSupported = supportedRating === rating.percent.toString() ||
                          (supportedRating === 'Requires Clinical Documentation' && rating.percent >= 30);
                ...
                {criteria.definitions && Object.keys(criteria.definitions).length > 0 && (
                    <div>
                      ...
                      >
                        <span>📖</span>
                        <span>{showDefinitions ? 'Hide' : 'Show'} Neuropathy Rating Definitions</span>
                      </button>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border-l-4 border-blue-500">
                  <h4 className="font-medium text-blue-900 dark:text-blue-300 mb-2">
                    Important: Peripheral Neuropathy Documentation
                  </h4>
                  <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-400">
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Document which extremities are affected (feet, hands, both)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Note if stocking-glove distribution (classic pattern)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Log paresthesia (numbness, tingling, burning)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>EMG/nerve conduction studies greatly strengthen claim</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Common causes: diabetes, Agent Orange, medications - document etiology</span>
                    </li>
                  </ul>
                </div>
...
export default PeripheralNeuropathyRatingCard;