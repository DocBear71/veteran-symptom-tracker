...
/**
 * Plantar Fasciitis Rating Card Component
 * Shows plantar fasciitis symptom analysis and VA rating
 */
const PlantarFasciitisRatingCard = ({ analysis, expanded, onToggle }) => {
              ...
              <div className="space-y-4 text-left">
                ...
                {criteria.definitions && Object.keys(criteria.definitions).length > 0 && (
                    <div>
                      ...
                      >
                        <span>📖</span>
                        <span>{showDefinitions ? 'Hide' : 'Show'} Plantar Fasciitis Definitions</span>
                      </button>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border-l-4 border-blue-500">
                  <h4 className="font-medium text-blue-900 dark:text-blue-300 mb-2">
                    Important: Plantar Fasciitis Documentation
                  </h4>
                  <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-400">
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Morning pain (first steps) is characteristic symptom</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Document if one foot (unilateral) or both feet (bilateral)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Track impact on walking, standing, weight-bearing</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Higher ratings require bilateral involvement</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Document treatments tried: orthotics, PT, injections</span>
                    </li>
                  </ul>
                </div>
...
export default PlantarFasciitisRatingCard;