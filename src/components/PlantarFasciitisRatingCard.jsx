...
export default function PlantarFasciitisRatingCard({ analysis, expanded, onToggle }) {
  ...
  const getRatingRowColor = (p, s) => {
    if (!s) return 'bg-gray-50 dark:bg-gray-700/30 border-gray-200 dark:border-gray-600';
    if (p >= 50) return 'bg-red-100 dark:bg-red-900/30 border-red-300 dark:border-red-700';
    if (p >= 30) return 'bg-orange-100 dark:bg-orange-900/30 border-orange-300 dark:border-orange-700';
    if (p >= 20) return 'bg-yellow-100 dark:bg-yellow-900/30 border-yellow-300 dark:border-yellow-700';
