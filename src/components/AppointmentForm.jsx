...
const AppointmentForm = ({ onSave, onCancel }) => {
  ...
  return (
      <form onSubmit={handleSubmit} className="space-y-4 p-4">
        <h2 className="text-lg font-semibold text-gray-800">Log Appointment</h2>
        ...
        <div>
          ...
          {errors.appointmentType && (
              <p id="type-error" className="text-red-500 text-sm mt-1">{errors.appointmentType}</p>
          )}
        </div>
        ...
        <div>
          ...
          <textarea
              ...
              rows={4}
              className={`w-full p-3 border rounded-lg ${
                  errors.discussed ? 'border-red-500' : 'border-gray-300'
              }`}
          />
          {errors.discussed && (
              <p className="text-red-500 text-sm mt-1">{errors.discussed}</p>
          )}
