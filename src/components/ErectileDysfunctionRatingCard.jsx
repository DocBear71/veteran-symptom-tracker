 ...
 * Displays VA rating analysis for Erectile Dysfunction (DC 7522)
        ...
        <button onClick={onToggle} className="w-full px-6 py-4 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              <h3 className="font-semibold text-lg text-gray-900 dark:text-white">Erectile Dysfunction</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">DC 7522 - 38 CFR 4.115b</p>
            </div>
          </div>
        ...
        {expanded && (
            <div className="px-6 pb-6 space-y-6">
              ...
              <ServiceConnectedBanner
                  conditionKey="erectileDysfunction"
              ...
              <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-200 dark:border-green-800">
                <h4 className="font-semibold text-green-900 dark:text-green-200 mb-2 flex items-center gap-2">
                  <span>💡</span>Why Service Connection Matters
                </h4>
                <p className="text-sm text-green-800 dark:text-green-300 mb-2">
                  While rated at 0%, service connection for erectile dysfunction is important because:
                </p>
                <ul className="space-y-1 text-sm text-green-700 dark:text-green-400">
                  <li className="flex items-start gap-2"><span className="mt-0.5">•</span><span>Potential eligibility for Special Monthly Compensation (SMC-K)</span></li>
                  <li className="flex items-start gap-2"><span className="mt-0.5">•</span><span>Establishes nexus to other service-connected conditions</span></li>
                  <li className="flex items-start gap-2"><span className="mt-0.5">•</span><span>May support secondary claims if additional conditions develop</span></li>
                </ul>
              </div>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                ...
                <ul className="space-y-1">
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2"><span className="text-blue-500 mt-0.5">•</span><span>Document frequency and severity of symptoms</span></li>
                  ...
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2"><span className="text-blue-500 mt-0.5">•</span><span>Record medication side effects if applicable</span></li>
                </ul>
              </div>

              {/* Disclaimer */}
              <div className="bg-gray-100 dark:bg-gray-700/50 rounded-lg p-3 text-xs text-gray-600 dark:text-gray-400">
                <strong>Important:</strong> Based on 38 CFR 4.115b, Diagnostic Code 7522 - Erectile Dysfunction. This analysis is for documentation purposes only.
              </div>
            </div>
        )}
      </div>
