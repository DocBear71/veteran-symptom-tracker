                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                      {analysis.metrics.symptomCounts.fever > 0 && (
                          <div className="bg-red-50 dark:bg-red-900/20 p-3 rounded-lg">
                            <p className="text-xs text-gray-600 dark:text-gray-400">Undulant Fever</p>
                      ...
                      {analysis.metrics.symptomCounts.backPain > 0 && (
                          <div className="bg-orange-50 dark:bg-orange-900/20 p-3 rounded-lg">
                            <p className="text-xs text-gray-600 dark:text-gray-400">Back Pain</p>
                            <p className="text-2xl font-bold text-orange-700 dark:text-orange-300">
                              {analysis.metrics.symptomCounts.backPain}
                            </p>
                          </div>
                      )}
                      ...
                      {analysis.metrics.symptomCounts.depression > 0 && (
                          <div className="bg-gray-50 dark:bg-gray-900/20 p-3 rounded-lg">
                            <p className="text-xs text-gray-600 dark:text-gray-400">Depression/Mood</p>
                            <p className="text-2xl font-bold text-gray-700 dark:text-gray-300">
                              {analysis.metrics.symptomCounts.depression}
                            </p>
                          </div>
                      )}
                    </div>
        ...
        {expanded && (
            <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
              <p className="text-xs text-gray-600 dark:text-gray-400">
                Based on 38 CFR 4.88b, Diagnostic Code 6316 - Brucellosis. This analysis is for documentation purposes only. The VA makes all final rating determinations.
              </p>
            </div>
        )}
      </div>
