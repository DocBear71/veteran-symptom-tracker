...
import { BRUCELLOSIS_CRITERIA, getRatingRowColor, getRatingTextColor } from '../utils/ratingCriteria';
 ...
 * Displays VA rating analysis for Brucellosis (DC 6330)
 * Based on 38 CFR 4.88b
 */
export default function BrucellosisRatingCard({ analysis, expanded, onToggle }) {
  if (!analysis || !analysis.hasData) {
    return null;
  }

  const { supportedRating, ratingRationale, evidence, gaps, metrics } = analysis;
  const criteria = BRUCELLOSIS_CRITERIA;
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden border-l-4 border-emerald-500">
        ...
        {expanded && (
            <div className="px-6 pb-6 space-y-6">
              ...
              {/* Supporting Evidence - populated by analyzeBrucellosisLogs */}
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                ...
                <ul className="space-y-1">
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2">
                    ...
                    <span>Document undulating fever patterns and night sweats</span>
                  </li>
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2">
                    <span className="text-blue-500 mt-0.5">•</span>
                    <span>Track joint and muscle pain episodes</span>
                  </li>
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2">
                    <span className="text-blue-500 mt-0.5">•</span>
                    <span>Associated with Gulf War deployments</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-gray-100 dark:bg-gray-700/50 rounded-lg p-3 text-xs text-gray-600 dark:text-gray-400">
                <strong>Important:</strong> Based on 38 CFR 4.88b, Diagnostic Code 6330 - Brucellosis.
