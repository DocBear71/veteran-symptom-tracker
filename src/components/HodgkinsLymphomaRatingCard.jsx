...
import { HODGKINS_LYMPHOMA_CRITERIA, getRatingRowColor, getRatingTextColor } from '../utils/ratingCriteria';
import UnderstandingYourRating from './UnderstandingYourRating';
import ServiceConnectedBanner from './ServiceConnectedBanner';

export default function HodgkinsLymphomaRatingCard({ analysis, expanded, onToggle }) {
  if (!analysis || !analysis.hasData) {
    return null;
  }

  const { supportedRating, rationale, evidenceGaps, metrics } = analysis;
  const criteria = HODGKINS_LYMPHOMA_CRITERIA;
            ...
            <div className="px-6 pb-6 space-y-6">
              ...
              <div className="bg-emerald-50 dark:bg-emerald-900/20 p-4 rounded-lg border border-emerald-200 dark:border-emerald-800">
                <h4 className="font-semibold text-emerald-900 dark:text-emerald-200 mb-2">
                  ⚠️ Important: Active Disease = 100% Rating
                </h4>
                <p className="text-sm text-emerald-800 dark:text-emerald-300">
                  During active disease or treatment phase, Hodgkin's Lymphoma is rated at 100%.
                  After treatment completion with no recurrence, rating is based on residuals.
                </p>
              </div>
