...
/**
 * Benign Oral Neoplasm Rating Card Component
 * Shows benign oral tumor analysis and VA rating (DC 9917)
 */
const BenignOralNeoplasmRatingCard = ({ analysis, expanded, onToggle }) => {
              ...
              <div className="space-y-4 text-left">
                      ...
                      return (
                          <div
                              ...
                              className={`p-2 rounded-lg border flex items-center gap-3 ${
                                  isSupported
                                      ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 border-2'
                ...
                {criteria.definitions && Object.keys(criteria.definitions).length > 0 && (
                    <div>
                      ...
                      >
                        <span>📖</span>
                        <span>{showDefinitions ? 'Hide' : 'Show'} Benign Neoplasm Definitions</span>
                      </button>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border-l-4 border-blue-500">
                  <h4 className="font-medium text-blue-900 dark:text-blue-300 mb-2">
                    Important: Benign Oral Tumor Documentation
                  </h4>
                  <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-400">
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Benign tumors do not receive automatic 100% rating (unlike malignant)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Rated based on functional impairment and residual effects</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Biopsy confirming benign status is required</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Document impact on chewing, swallowing, speaking, and appearance</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>If tumor causes tissue loss or disfigurement, may rate under DC 9900-9916 or DC 7800</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Keep imaging studies (CT, MRI) showing size and location</span>
                    </li>
                  </ul>
                </div>
...
export default BenignOralNeoplasmRatingCard;