...
export default function ImmuneThrombocytopeniaRatingCard({ analysis, expanded, onToggle }) {
            ...
            <div className="px-6 pb-6 space-y-6">
              ...
              {ratingDetails && (
                  <div className="bg-violet-50 dark:bg-violet-900/20 p-4 rounded-lg">
                    ...
                    <p className="text-violet-800 dark:text-violet-300 mb-3">
                      ...
                      {metrics.lowestPlateletCount && (
                          <div className="bg-red-50 dark:bg-red-900/20 p-3 rounded-lg">
                            <div className="text-2xl font-bold text-red-600 dark:text-red-400">
                              {metrics.lowestPlateletCount.toLocaleString()}
                            </div>
                            <div className="text-xs text-red-700 dark:text-red-300">
                              Lowest Platelet Count/μL
                            </div>
                          </div>
                      )}
