...
import { Q_FEVER_CRITERIA, getRatingRowColor, getRatingTextColor } from '../utils/ratingCriteria';
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden border-l-4 border-emerald-500">
        ...
        {expanded && (
            <div className="px-6 pb-6 space-y-6">
              ...
              {/* Supporting Evidence - string array from analyzeQFeverLogs */}
