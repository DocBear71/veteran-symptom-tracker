...
import { LYME_DISEASE_CRITERIA, getRatingRowColor, getRatingTextColor } from '../utils/ratingCriteria';
import UnderstandingYourRating from './UnderstandingYourRating';
import ServiceConnectedBanner from './ServiceConnectedBanner';

/**
 * Lyme Disease Rating Card Component - Gold Standard Version
 * Displays VA rating analysis for Lyme Disease (DC 6319)
...
export default function LymeDiseaseRatingCard({ analysis, expanded, onToggle }) {
  ...
  const criteria = LYME_DISEASE_CRITERIA;
        ...
        {expanded && (
            <div className="px-6 pb-6 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  ...
                  <div className={`p-3 rounded-lg text-center ${
                      metrics?.symptomCounts?.jointPain > 0
                  ...
                  <div className={`p-3 rounded-lg text-center ${
                      metrics?.symptomCounts?.neurologicalSymptoms > 0
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                ...
                <ul className="space-y-1">
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2">
                    ...
                    <span>Document joint pain, fatigue, and neurological symptoms</span>
                  </li>
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2">
                    <span className="text-blue-500 mt-0.5">•</span>
                    <span>Track cognitive issues (brain fog, memory problems)</span>
                  </li>
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2">
                    <span className="text-blue-500 mt-0.5">•</span>
                    <span>Residuals may be rated separately under specific body systems</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-gray-100 dark:bg-gray-700/50 rounded-lg p-3 text-xs text-gray-600 dark:text-gray-400">
                <strong>Important:</strong> Based on 38 CFR 4.88b, Diagnostic Code 6319 - Lyme Disease.
