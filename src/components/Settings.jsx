...
const Settings = () => {
    ...
    const [dataStats, setDataStats] = useState({ logs: 0, customSymptoms: 0, favorites: 0, appointments: 0 });
    ...
    const handleDeleteAllData = () => {
        ...
        localStorage.removeItem('symptomTracker_favorites'); // Legacy key cleanup
                        ...
                        <div className="p-4">
                            <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg p-3 mb-4">
                                ...
                                <p className="text-red-700 dark:text-red-300 text-sm mt-1">
                                    ...
                                    {dataStats.appointments || 0} appointments, {dataStats.customSymptoms} custom symptoms,
                                    and {dataStats.favorites} favorites. This action cannot be undone.
                                </p>
                            </div>
