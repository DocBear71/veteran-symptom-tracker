// ==================================================================
// ENHANCED HYPERTENSION RATING CARD
// ==================================================================
// Add this component to RatingEvidence.jsx
// Replace or enhance the existing hypertension card
...
/**
 * Enhanced Hypertension Rating Card with BP Chart
 * Shows blood pressure trends and VA rating analysis
 */
const HypertensionRatingCard = ({ analysis, expanded, onToggle }) => {
  ...
  const {
    ...
    criteria,
    disclaimer,
    measurements, // BP measurements for chart
  } = analysis;
        ...
        >
          ...
          <div className="flex items-center gap-3">
            {supportedRating && (
              ...
              {supportedRating.includes('%') ? supportedRating : `${supportedRating}%`}
            </span>
            )}
            <svg
              ...
              <div className="space-y-4">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border-l-4 border-blue-500">
                  <h4 className="font-medium text-blue-900 dark:text-blue-300 mb-2">
                    Important: Blood Pressure Documentation
                  </h4>
                  <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-400">
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>VA ratings based on "predominantly" (more than 50%) of readings at threshold</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Need readings on at least 3 different days over 2-3 months</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Document medication status (before/after) with each reading</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Position (sitting/standing/lying) can affect readings</span>
                    </li>
                  </ul>
                </div>
...
export default HypertensionRatingCard;