      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
        ...
        {expanded && (
            <div>
              ...
              {/* Complications Alert */}
              {(analysis.metrics?.bacteremia || analysis.metrics?.hospitalized) && (
                  <div className="mb-4">
                    <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-2">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                      ...
                      {analysis.metrics.symptomCounts.bloodyStool > 0 && (
                          <div className="bg-red-50 dark:bg-red-900/20 p-3 rounded-lg">
                            <p className="text-xs text-gray-600 dark:text-gray-400">Bloody Stool</p>
        ...
        {expanded && (
            <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
              <p className="text-xs text-gray-600 dark:text-gray-400">
                Based on 38 CFR 4.88b, Diagnostic Code 6333 - Nontyphoid Salmonella. Associated with Gulf War deployments. This analysis is for documentation purposes only. The VA makes all final rating determinations.
              </p>
            </div>
        )}
      </div>
