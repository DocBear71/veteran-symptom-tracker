...
import { SALMONELLA_CRITERIA, getRatingRowColor, getRatingTextColor } from '../utils/ratingCriteria';
...
export default function SalmonellaRatingCard({ analysis, expanded, onToggle }) {
  ...
  const criteria = SALMONELLA_CRITERIA;
        ...
        <button onClick={onToggle} className="w-full px-6 py-4 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              <h3 className="font-semibold text-lg text-gray-900 dark:text-white">Nontyphoid Salmonella Infection</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">DC 6333 - 38 CFR 4.88b</p>
            </div>
          </div>
            ...
            <div className="px-6 pb-6 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  ...
                  <div className={`p-3 rounded-lg text-center ${metrics?.bacteremia ? 'bg-red-50 dark:bg-red-900/20' : 'bg-gray-50 dark:bg-gray-700/30'}`}>
                    <div className={`text-2xl font-bold ${metrics?.bacteremia ? 'text-red-600 dark:text-red-400' : 'text-gray-400'}`}>{metrics?.bacteremia ? '⚠' : '—'}</div>
                    <div className="text-xs text-gray-600 dark:text-gray-400">Bacteremia</div>
                  </div>
                </div>
              </div>
              <MedicationCorrelation analysis={analysis} />

              {/* Supporting Evidence - string array from analyzeSalmonellaLogs */}
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                ...
                <ul className="space-y-1">
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2"><span className="text-blue-500 mt-0.5">•</span><span>Document all GI symptoms including bloody diarrhea</span></li>
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2"><span className="text-blue-500 mt-0.5">•</span><span>Bacteremia/sepsis requires hospitalization documentation</span></li>
              ...
              <div className="bg-gray-100 dark:bg-gray-700/50 rounded-lg p-3 text-xs text-gray-600 dark:text-gray-400">
                <strong>Important:</strong> Based on 38 CFR 4.88b, Diagnostic Code 6333 - Nontyphoid Salmonella. This analysis is for documentation purposes only.
              </div>
            </div>
        )}
      </div>
