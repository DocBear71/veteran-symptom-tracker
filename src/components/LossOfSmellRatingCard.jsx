...
import { LOSS_OF_SMELL_CRITERIA } from '../utils/ratingLogic/';
 ...
 *
 * Rating: 10% for complete loss of sense of smell with diagnosed cause
 * Common secondary to: TBI, COVID-19, Sinusitis, Parkinson's Disease
 */
export default function LossOfSmellRatingCard({ analysis, expanded, onToggle }) {
  if (!analysis || !analysis.hasData) return null;

  const { supportedRating, rationale, evidenceGaps, metrics } = analysis;
  const criteria = LOSS_OF_SMELL_CRITERIA;
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                ...
                <ul className="space-y-1">
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2">
                    ...
                    <span>Complete loss (anosmia) required for 10% rating</span>
                  </li>
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2">
                    <span className="text-blue-500 mt-0.5">•</span>
                  ...
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2">
                    <span className="text-blue-500 mt-0.5">•</span>
                    <span>Request UPSIT or equivalent smell testing from ENT</span>
                  </li>
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2">
                    <span className="text-blue-500 mt-0.5">•</span>
                    <span>Document safety impacts (gas leaks, smoke, spoiled food)</span>
                  </li>
                  {(metrics?.postCovidCount > 0 || metrics?.postTbiCount > 0) && (
                      <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2">
                        <span className="text-blue-500 mt-0.5">•</span>
                        <span>If secondary to another condition, document the nexus relationship</span>
                      </li>
                  )}
                </ul>
              </div>
