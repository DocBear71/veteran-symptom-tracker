...
import { MYELODYSPLASTIC_SYNDROMES_CRITERIA } from '../utils/ratingCriteria';

export default function MyelodysplasticSyndromesRatingCard({ analysis, expanded, onToggle }) {
  ...
  return (
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden border-l-4 border-slate-500">
        {/* Header */}
        <button
            onClick={onToggle}
            ...
            <div className="px-6 pb-6 space-y-6">
              ...
              {ratingDetails && (
                  <div className="bg-slate-50 dark:bg-slate-900/20 p-4 rounded-lg">
                    <h4 className="font-semibold text-slate-900 dark:text-slate-200 mb-2">
                      {supportedRating}% Rating Criteria
                    </h4>
                    <p className="text-slate-800 dark:text-slate-300 mb-3">
              ...
              {metrics && (
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      {metrics.transfusionCount > 0 && (
                          <div className="bg-red-50 dark:bg-red-900/20 p-3 rounded-lg">
                            <div className="text-2xl font-bold text-red-600 dark:text-red-400">
                              {metrics.transfusionCount}
                            </div>
