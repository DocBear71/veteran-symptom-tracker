...
/**
 * Chronic Fatigue Syndrome Rating Card Component
 * Shows CFS symptom analysis and VA rating
 */
const ChronicFatigueRatingCard = ({ analysis, expanded, onToggle }) => {
              ...
              <div className="space-y-4">
                ...
                {criteria.definitions && Object.keys(criteria.definitions).length > 0 && (
                    <div>
                      ...
                      >
                        <span>📖</span>
                        <span>{showDefinitions ? 'Hide' : 'Show'} CFS Rating Definitions</span>
                      </button>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border-l-4 border-blue-500">
                  <h4 className="font-medium text-blue-900 dark:text-blue-300 mb-2">
                    Important: CFS Documentation
                  </h4>
                  <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-400">
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Log debilitating fatigue episodes (not just feeling tired)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Document cognitive impairment ("brain fog")</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Track sleep disturbance and chronic pain</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Note post-exertional malaise (crash after activity)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Higher ratings require multiple symptom types documented</span>
                    </li>
                  </ul>
                </div>
...
export default ChronicFatigueRatingCard;