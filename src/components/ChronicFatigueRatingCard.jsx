...
import {CHRONIC_FATIGUE_CRITERIA} from '../utils/ratingCriteria';
...
export default function ChronicFatigueRatingCard({
  ...
  const criteria = CHRONIC_FATIGUE_CRITERIA;
  ...
  return (
      <div
          className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden border-l-4 border-violet-500">
        <button onClick={onToggle}
          ...
          <div className="flex items-center gap-3"><span
            ...
            <div className="text-left"><h3
              ...
              Fatigue Syndrome</h3><p
                className="text-sm text-gray-600 dark:text-gray-400">DC 6354 -
              38 CFR 4.88b</p></div>
          </div>
          <div className="flex items-center gap-4">
            <div className="text-right">
              <div
                  className="text-2xl font-bold text-violet-600 dark:text-violet-400">{supportedRating !==
            ...
            <div className="px-6 pb-6 space-y-6">
              ...
              <div><h4
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  ...
                  <div
                      className="bg-red-50 dark:bg-red-900/20 p-3 rounded-lg text-center">
                    <div
                        className="text-2xl font-bold text-red-600 dark:text-red-400">{metrics?.debilitatingDays ||
                        0}</div>
                    <div
                        className="text-xs text-gray-600 dark:text-gray-400">Debilitated
                      Days
                    </div>
                  </div>
                  <div
                    ...
                    <div
                        className="text-2xl font-bold text-purple-600 dark:text-purple-400">{metrics?.cognitiveIssues ||
                        0}</div>
                    <div
                        className="text-xs text-gray-600 dark:text-gray-400">Cognitive
                      Issues
                    </div>
                  </div>
                  <div
                      className="bg-orange-50 dark:bg-orange-900/20 p-3 rounded-lg text-center">
                    <div
                        className="text-2xl font-bold text-orange-600 dark:text-orange-400">{metrics?.bedrestDays ||
                        0}</div>
                    <div
                        className="text-xs text-gray-600 dark:text-gray-400">Bedrest
                      Days
                    </div>
                  </div>
                </div>
              ...
              <div
                ...
                <ul className="space-y-1">
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2">
                    <span className="text-blue-500 mt-0.5">•</span><span>Track debilitating fatigue that doesn't improve with rest</span>
                  </li>
                  <li className="text-sm text-blue-800 dark:text-blue-300 flex items-start gap-2">
                    <span className="text-blue-500 mt-0.5">•</span><span>Document cognitive impairment (brain fog)</span>
                  </li>
                </ul>
              </div>
              <div
                  className="bg-gray-100 dark:bg-gray-700/50 rounded-lg p-3 text-xs text-gray-600 dark:text-gray-400">
                <strong>Important:</strong> Based on 38 CFR 4.88b, DC 6354 -
                CFS. For documentation purposes only.
              </div>
            </div>
        )}
      </div>
