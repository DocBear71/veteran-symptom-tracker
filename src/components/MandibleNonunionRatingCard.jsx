...
/**
 * Mandible Nonunion/Malunion Rating Card Component
 * Shows mandible fracture healing analysis and VA rating (DC 9903-9904)
 */
const MandibleNonunionRatingCard = ({ analysis, expanded, onToggle }) => {
              ...
              <div className="space-y-4 text-left">
                ...
                {criteria.definitions && Object.keys(criteria.definitions).length > 0 && (
                    <div>
                      ...
                      >
                        <span>📖</span>
                        <span>{showDefinitions ? 'Hide' : 'Show'} Mandible Fracture Definitions</span>
                      </button>
                ...
                <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-4 border-l-4 border-amber-500">
                  <h4 className="font-medium text-amber-900 dark:text-amber-300 mb-2">
                    Important: Mandible Fracture Documentation
                  </h4>
                  <ul className="space-y-2 text-sm text-amber-800 dark:text-amber-400">
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>X-rays or CT scans showing nonunion or malunion are essential</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Document jaw instability, facial asymmetry, and bite problems</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Track difficulty chewing and dietary restrictions</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Measure jaw opening limitation if present</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>May combine with TMJ rating if both conditions exist</span>
                    </li>
                  </ul>
                </div>
...
export default MandibleNonunionRatingCard;