...
/**
 * Asthma Rating Card Component
 * Shows asthma symptom analysis and VA rating based on FEV-1 and attack frequency
 */
const AsthmaRatingCard = ({ analysis, expanded, onToggle }) => {
              ...
              <div className="space-y-4">
                ...
                {criteria.definitions && Object.keys(criteria.definitions).length > 0 && (
                    <div>
                      ...
                      >
                        <span>📖</span>
                        <span>{showDefinitions ? 'Hide' : 'Show'} Asthma Rating Definitions</span>
                      </button>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border-l-4 border-blue-500">
                  <h4 className="font-medium text-blue-900 dark:text-blue-300 mb-2">
                    Important: Asthma Documentation
                  </h4>
                  <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-400">
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>FEV-1 measurements are the most important evidence for VA ratings</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Use post-bronchodilator results unless pre-bronchodilator values are worse</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Track all asthma attacks and exacerbations requiring treatment</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Document medication usage (rescue inhalers, daily controllers, oral steroids)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Keep records of ER visits and physician visits for exacerbations</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Note: VA accepts verified history of asthmatic attacks if not currently symptomatic</span>
                    </li>
                  </ul>
                </div>
...
export default AsthmaRatingCard;