...
const RatingEvidence = () => {
  ...
  const activeConditions = useMemo(() => {
    ...
    tinnitusAnalysis,
    sleepApneaAnalysis,
    fibromyalgiaAnalysis,
    hypertensionAnalysis,
    peripheralNeuropathyAnalysis,
    migraineAnalysis,
  ...
  const bodySystemCounts = useMemo(() => {
    const hasData = (a) => a?.hasData === true;
    return {
      mentalHealth: [
        ptsdAnalysis,
        majorDepressionAnalysis,
        generalizedAnxietyAnalysis,
        panicDisorderAnalysis,
        bipolarAnalysis,
        socialAnxietyAnalysis,
        ocdAnalysis,
        persistentDepressiveAnalysis,
        adjustmentDisorderAnalysis,
        unspecifiedAnxietyAnalysis,
        unspecifiedDepressiveAnalysis,
        somaticSymptomDisorderAnalysis,
        otherSpecifiedSomaticAnalysis,
        unspecifiedSomaticAnalysis,
        illnessAnxietyAnalysis,
        otherSpecifiedAnxietyAnalysis,
        depersonalizationAnalysis,
        cyclothymicAnalysis,
        anorexiaNervosaAnalysis,
        bulimiaNervosaAnalysis,
        schizophreniaAnalysis,
        schizoaffectiveDisorderAnalysis,
        delusionalDisorderAnalysis,
        psychoticDisorderNOSAnalysis,
        briefPsychoticDisorderAnalysis,
        bingeEatingDisorderAnalysis,
        dissociativeIdentityDisorderAnalysis,
        dissociativeAmnesiaAnalysis,
        acuteStressDisorderAnalysis,
        antisocialPersonalityDisorderAnalysis,
        borderlinePersonalityDisorderAnalysis,
        narcissisticPersonalityDisorderAnalysis,
        avoidantPersonalityDisorderAnalysis,
        dementiaAnalysis,
      ...
      neurological: [
        migraineAnalysis,
        tbiAnalysis,
        tbiResidualsAnalysis,
        epilepsyMajorAnalysis,
        epilepsyMinorAnalysis,
        jacksonianEpilepsyAnalysis,
        diencephalicEpilepsyAnalysis,
        psychomotorEpilepsyAnalysis,
        radiculopathyAnalysis,
        peripheralNeuropathyAnalysis,
        multipleSclerosisAnalysis,
        parkinsonsAnalysis,
        myastheniaGravisAnalysis,
        narcolepsyAnalysis,
        alsAnalysis,
        syringomyeliaAnalysis,
        myelitisAnalysis,
        upperRadicularAnalysis,
        middleRadicularAnalysis,
        lowerRadicularAnalysis,
        allRadicularAnalysis,
        radialNerveAnalysis,
        medianNerveAnalysis,
        ulnarNerveAnalysis,
        musculocutaneousNerveAnalysis,
        circumflexNerveAnalysis,
        longThoracicNerveAnalysis,
        sciaticNerveAnalysis,
        commonPeronealNerveAnalysis,
        superficialPeronealNerveAnalysis,
        deepPeronealNerveAnalysis,
        tibialNerveAnalysis,
        posteriorTibialNerveAnalysis,
        femoralNerveAnalysis,
        saphenousNerveAnalysis,
        obturatorNerveAnalysis,
        lateralFemoralCutaneousNerveAnalysis,
        ilioinguinalNerveAnalysis,
      ].filter(hasData).length,

      musculoskeletal: [
        lumbosacralStrainAnalysis,
        intervertebralDiscAnalysis,
        kneeInstabilityAnalysis,
        shoulderAnalysis,
        hipAnalysis,
        ankleAnalysis,
        ankleAchillesAnalysis,
        hipThighAnalysis,
        wristAnalysis,
        elbowAnalysis,
        degenerativeArthritisAnalysis,
        plantarFasciitisAnalysis,
        tmjAnalysis,
        fibromyalgiaAnalysis,
        goutAnalysis,
        bursitisAnalysis,
        tendinitisAnalysis,
        myositisAnalysis,
        osteomyelitisAnalysis,
        multiJointArthritisAnalysis,
        vertebralFractureAnalysis,
        sacroiliacInjuryAnalysis,
        spinalStenosisAnalysis,
        ankylosingSpondylitisAnalysis,
        spinalFusionAnalysis,
        weakFootAnalysis,
        clawFootAnalysis,
        metatarsalgiaAnalysis,
        halluxValgusAnalysis,
        halluxRigidusAnalysis,
        amputationAnalysis,
      ].filter(hasData).length,
      ...
      respiratory: [
        ...
        rhinitisAnalysis,
        sinusitisAnalysis,
        deviatedSeptumAnalysis,
        noseLossAnalysis,
        chronicLaryngitisAnalysis,
        aphoniaAnalysis,
        laryngealStenosisAnalysis,
        pharynxInjuryAnalysis,
        copdAnalysis,
        chronicBronchitisAnalysis,
        emphysemaAnalysis,
        bronchiectasisAnalysis,
        pulmonaryFibrosisAnalysis,
        sarcoidosisAnalysis,
      ].filter(hasData).length,

      cardiovascular: [
        hypertensionAnalysis,
        cardiomyopathyAnalysis,
        svtAnalysis,
        ventricularArrhythmiaAnalysis,
        pericarditisAnalysis,
        postPhlebiticAnalysis,
        cadAnalysis,
        postMIAnalysis,
        hypertensiveHeartAnalysis,
        coldInjuryAnalysis,
        padAnalysis,
        raynaudsAnalysis,
      ...
      digestive: [
        ibsAnalysis,
        gerdAnalysis,
        GERDComplicationsAnalysis,
        ulcerativeColitisAnalysis,
        pepticUlcerAnalysis,
        hemorrhoidAnalysis,
        diverticulitisAnalysis,
        cirrhosisAnalysis,
        gastritisAnalysis,
        pancreatitisAnalysis,
        biliaryTractAnalysis,
        herniaAnalysis,
        peritonealAdhesionsAnalysis,
        esophagealAnalysis,
      ...
      endocrine: [
        diabetesAnalysis,
        hypothyroidismAnalysis,
        hyperthyroidismAnalysis,
        thyroiditisAnalysis,
        hyperparathyroidismAnalysis,
        hypoparathyroidismAnalysis,
        addisonsDiseaseAnalysis,
        cushingsSyndromeAnalysis,
        diabetesInsipidusAnalysis,
      ...
      skin: [
        ...
        acneAnalysis,
        chloracneAnalysis,
        alopeciaAreataAnalysis,
        hyperhidrosisAnalysis,
        discoidLupusAnalysis,
        bullousDisordersAnalysis,
      ...
      eyeEar: [
        ...
        uveitisAnalysis,
        keratitisAnalysis,
        chronicConjunctivitisAnalysis,
        scleritisAnalysis,
        peripheralVestibularAnalysis,
        chronicSuppurativeOtitisMediaAnalysis,
        chronicOtitisExternaAnalysis,
        chronicNonsuppurativeOtitisMediaAnalysis,
      ].filter(hasData).length,

      hemicLymphatic: [
        ironDeficiencyAnemiaAnalysis,
        folateDeficiencyAnemiaAnalysis,
        perniciousAnemiaAnalysis,
        hemolyticAnemiaAnalysis,
        sickleCellAnemiaAnalysis,
        aplasticAnemiaAnalysis,
        polycythemiaVeraAnalysis,
        immuneThrombocytopeniaAnalysis,
        leukemiaAnalysis,
        hodgkinsLymphomaAnalysis,
        multipleMyelomaAnalysis,
        nonHodgkinsLymphomaAnalysis,
        myeloproliferative7718Analysis,
        chronicMyelogenousLeukemiaAnalysis,
        solitaryPlasmacytomaAnalysis,
        myelodysplasticSyndromesAnalysis,
      ].filter(hasData).length,
      ...
      infectious: [
        ...
        tabesDorsalisAnalysis,
        syphiliticDementiaAnalysis,
        syphiliticHeartDiseaseAnalysis,
      ].filter(hasData).length,
    ...
    // Mental Health
    ptsdAnalysis, majorDepressionAnalysis, generalizedAnxietyAnalysis,
    panicDisorderAnalysis, bipolarAnalysis, socialAnxietyAnalysis,
    ocdAnalysis, persistentDepressiveAnalysis, adjustmentDisorderAnalysis,
    unspecifiedAnxietyAnalysis, unspecifiedDepressiveAnalysis,
    somaticSymptomDisorderAnalysis, otherSpecifiedSomaticAnalysis,
    unspecifiedSomaticAnalysis, illnessAnxietyAnalysis,
    otherSpecifiedAnxietyAnalysis, depersonalizationAnalysis,
    cyclothymicAnalysis, anorexiaNervosaAnalysis, bulimiaNervosaAnalysis,
    schizophreniaAnalysis, schizoaffectiveDisorderAnalysis,
    delusionalDisorderAnalysis, psychoticDisorderNOSAnalysis,
    briefPsychoticDisorderAnalysis, bingeEatingDisorderAnalysis,
    dissociativeIdentityDisorderAnalysis, dissociativeAmnesiaAnalysis,
    acuteStressDisorderAnalysis, antisocialPersonalityDisorderAnalysis,
    borderlinePersonalityDisorderAnalysis, narcissisticPersonalityDisorderAnalysis,
    avoidantPersonalityDisorderAnalysis, dementiaAnalysis,
    // Neurological
    migraineAnalysis, tbiAnalysis, tbiResidualsAnalysis,
    epilepsyMajorAnalysis, epilepsyMinorAnalysis, jacksonianEpilepsyAnalysis,
    diencephalicEpilepsyAnalysis, psychomotorEpilepsyAnalysis,
    radiculopathyAnalysis, peripheralNeuropathyAnalysis,
    multipleSclerosisAnalysis, parkinsonsAnalysis, myastheniaGravisAnalysis,
    narcolepsyAnalysis, alsAnalysis, syringomyeliaAnalysis,
    myelitisAnalysis, upperRadicularAnalysis, middleRadicularAnalysis,
    lowerRadicularAnalysis, allRadicularAnalysis, radialNerveAnalysis,
    medianNerveAnalysis, ulnarNerveAnalysis, musculocutaneousNerveAnalysis,
    circumflexNerveAnalysis, longThoracicNerveAnalysis, sciaticNerveAnalysis,
    commonPeronealNerveAnalysis, superficialPeronealNerveAnalysis,
    deepPeronealNerveAnalysis, tibialNerveAnalysis, posteriorTibialNerveAnalysis,
    femoralNerveAnalysis, saphenousNerveAnalysis, obturatorNerveAnalysis,
    lateralFemoralCutaneousNerveAnalysis, ilioinguinalNerveAnalysis,
    // Musculoskeletal
    lumbosacralStrainAnalysis, intervertebralDiscAnalysis, kneeInstabilityAnalysis,
    shoulderAnalysis, hipAnalysis, ankleAnalysis, wristAnalysis,
    elbowAnalysis, degenerativeArthritisAnalysis, plantarFasciitisAnalysis,
    tmjAnalysis, fibromyalgiaAnalysis, goutAnalysis, bursitisAnalysis,
    tendinitisAnalysis, myositisAnalysis, osteomyelitisAnalysis,
    multiJointArthritisAnalysis, vertebralFractureAnalysis, sacroiliacInjuryAnalysis,
    spinalStenosisAnalysis, ankylosingSpondylitisAnalysis, spinalFusionAnalysis,
    weakFootAnalysis, clawFootAnalysis, metatarsalgiaAnalysis,
    halluxValgusAnalysis, halluxRigidusAnalysis,
    amputationAnalysis,
    // Respiratory
    sleepApneaAnalysis, asthmaAnalysis, rhinitisAnalysis,
    sinusitisAnalysis, deviatedSeptumAnalysis, noseLossAnalysis,
    chronicLaryngitisAnalysis, aphoniaAnalysis, laryngealStenosisAnalysis, pharynxInjuryAnalysis,
    copdAnalysis, chronicBronchitisAnalysis,
    emphysemaAnalysis, bronchiectasisAnalysis, pulmonaryFibrosisAnalysis,
    sarcoidosisAnalysis,
    // Cardiovascular
    hypertensionAnalysis, cardiomyopathyAnalysis, svtAnalysis,
    ...
    addisonsDiseaseAnalysis, cushingsSyndromeAnalysis, diabetesInsipidusAnalysis,
    hyperaldosteronismAnalysis,
    // Genitourinary
    ...
    scleritisAnalysis, peripheralVestibularAnalysis, chronicSuppurativeOtitisMediaAnalysis,
    chronicOtitisExternaAnalysis, chronicNonsuppurativeOtitisMediaAnalysis,
    // Hemic/Lymphatic
    ironDeficiencyAnemiaAnalysis, folateDeficiencyAnemiaAnalysis, perniciousAnemiaAnalysis,
    hemolyticAnemiaAnalysis, sickleCellAnemiaAnalysis, aplasticAnemiaAnalysis,
    polycythemiaVeraAnalysis, immuneThrombocytopeniaAnalysis, leukemiaAnalysis,
    hodgkinsLymphomaAnalysis, multipleMyelomaAnalysis, nonHodgkinsLymphomaAnalysis,
    myeloproliferative7718Analysis, chronicMyelogenousLeukemiaAnalysis,
    solitaryPlasmacytomaAnalysis, myelodysplasticSyndromesAnalysis,
    // Infectious
    ...
    ankleAchillesAnalysis, hipThighAnalysis,
