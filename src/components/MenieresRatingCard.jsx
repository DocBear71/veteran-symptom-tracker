...
/**
 * Meniere's Disease Rating Card Component
 * Shows Meniere's symptom analysis and VA rating
 */
const MenieresRatingCard = ({ analysis, expanded, onToggle }) => {
              ...
              <div className="space-y-4 text-left">
                ...
                {criteria.definitions && Object.keys(criteria.definitions).length > 0 && (
                    <div>
                      ...
                      >
                        <span>📖</span>
                        <span>{showDefinitions ? 'Hide' : 'Show'} Meniere's Rating Definitions</span>
                      </button>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border-l-4 border-blue-500">
                  <h4 className="font-medium text-blue-900 dark:text-blue-300 mb-2">
                    Important: Meniere's Disease Documentation
                  </h4>
                  <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-400">
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Log vertigo attacks (spinning sensation, not just dizziness)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Document classic triad: vertigo + tinnitus + hearing loss</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Track attack duration (minutes to hours)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Note if attacks require bed rest</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>All ratings require ENT evaluation with audiometry</span>
                    </li>
                  </ul>
                </div>
...
export default MenieresRatingCard;