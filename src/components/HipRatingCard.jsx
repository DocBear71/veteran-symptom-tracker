...
/**
 * Hip Conditions Rating Card Component
 * Shows hip symptom analysis and VA rating
 */
const HipRatingCard = ({ analysis, expanded, onToggle }) => {
              ...
              <div className="space-y-4">
                ...
                {criteria.definitions && Object.keys(criteria.definitions).length > 0 && (
                    <div>
                      ...
                      >
                        <span>📖</span>
                        <span>{showDefinitions ? 'Hide' : 'Show'} Hip Rating Definitions</span>
                      </button>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border-l-4 border-blue-500">
                  ...
                  <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-400">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>60-50% = Hip ankylosis (surgical fusion)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>40% = Marked limitation + severe pain</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>30% = Moderate limitation of motion</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>20% = Slight-moderate limitation</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Document functional impact: walking, stairs, sitting</span>
                    </li>
                  </ul>
                </div>
