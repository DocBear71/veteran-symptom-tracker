...
import { SOLITARY_PLASMACYTOMA_CRITERIA } from '../utils/ratingCriteria';
            ...
            <div className="px-6 pb-6 space-y-6">
              ...
              {ratingDetails && (
                  <div className="bg-lime-50 dark:bg-lime-900/20 p-4 rounded-lg">
                    <h4 className="font-semibold text-lime-900 dark:text-lime-200 mb-2">
                      {supportedRating}% Rating Criteria
                    </h4>
                    <p className="text-lime-800 dark:text-lime-300 mb-3">
                      {ratingDetails.summary}
                    </p>
                    <ul className="space-y-1">
                      {ratingDetails.criteriaDescription.map((item, idx) => (
                          <li key={idx} className="text-sm text-lime-700 dark:text-lime-400 flex items-start gap-2">
