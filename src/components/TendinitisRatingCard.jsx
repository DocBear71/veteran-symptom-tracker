 ...
 */
export default function TendinitisRatingCard({ analysis, expanded, onToggle }) {
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden border-l-4 border-amber-500">
        ...
        {expanded && (
            <div className="px-6 pb-6 space-y-6">
              ...
              {/* Tendinitis-Specific Information */}
              <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg border border-amber-200 dark:border-amber-800">
                ...
                <ul className="space-y-1">
                  <li className="text-sm text-amber-800 dark:text-amber-300 flex items-start gap-2">
                    ...
                    <span><strong>Shoulder:</strong> Rotator cuff tendinitis, biceps tendinitis</span>
                  </li>
                  <li className="text-sm text-amber-800 dark:text-amber-300 flex items-start gap-2">
                    <span className="text-amber-500 mt-0.5">•</span>
                    <span><strong>Elbow:</strong> Tennis elbow (lateral), Golfer's elbow (medial)</span>
                  </li>
                  <li className="text-sm text-amber-800 dark:text-amber-300 flex items-start gap-2">
                    <span className="text-amber-500 mt-0.5">•</span>
                    <span><strong>Wrist:</strong> De Quervain's tenosynovitis</span>
                  </li>
                  <li className="text-sm text-amber-800 dark:text-amber-300 flex items-start gap-2">
                    <span className="text-amber-500 mt-0.5">•</span>
                    <span><strong>Knee:</strong> Patellar tendinitis ("jumper's knee")</span>
                  </li>
                  <li className="text-sm text-amber-800 dark:text-amber-300 flex items-start gap-2">
                    <span className="text-amber-500 mt-0.5">•</span>
                    <span><strong>Ankle:</strong> Achilles tendinitis, posterior tibial tendinitis</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-gray-100 dark:bg-gray-700/50 rounded-lg p-3 text-xs text-gray-600 dark:text-gray-400">
                <strong>Important:</strong> {criteria?.disclaimer || 'Tendinitis/Tenosynovitis (DC 5024) is rated as degenerative arthritis per 38 CFR 4.71a. Imaging and treatment records strengthen claims. For documentation purposes only.'}
              </div>
            </div>
        )}
      </div>
