...
import { CHRONIC_MYELOGENOUS_LEUKEMIA_CRITERIA } from '../utils/ratingCriteria';
            ...
            <div className="px-6 pb-6 space-y-6">
              ...
              {ratingDetails && (
                  <div className="bg-sky-50 dark:bg-sky-900/20 p-4 rounded-lg">
                    <h4 className="font-semibold text-sky-900 dark:text-sky-200 mb-2">
                      {supportedRating}% Rating Criteria
                    </h4>
                    <p className="text-sky-800 dark:text-sky-300 mb-3">
                      {ratingDetails.summary}
                    </p>
                    <ul className="space-y-1">
                      {ratingDetails.criteriaDescription.map((item, idx) => (
                          <li key={idx} className="text-sm text-sky-700 dark:text-sky-400 flex items-start gap-2">
