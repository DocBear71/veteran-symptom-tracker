...
/**
 * Shoulder Conditions Rating Card Component
 * Shows shoulder symptom analysis and VA rating
 */
const ShoulderRatingCard = ({ analysis, expanded, onToggle }) => {
              ...
              <div className="space-y-4">
                ...
                {criteria.definitions && Object.keys(criteria.definitions).length > 0 && (
                    <div>
                      ...
                      >
                        <span>📖</span>
                        <span>{showDefinitions ? 'Hide' : 'Show'} Shoulder Rating Definitions</span>
                      </button>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border-l-4 border-blue-500">
                  <h4 className="font-medium text-blue-900 dark:text-blue-300 mb-2">
                    Important: Shoulder Documentation
                  </h4>
                  <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-400">
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>ROM measurements required for formal rating</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>40% = Severe limitation (&lt;90° forward elevation)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>30% = Moderate limitation (90-120°)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>20% = Slight-moderate (120-160°)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>10% = Slight impairment or recurrent instability</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Document which shoulder or if bilateral</span>
                    </li>
                  </ul>
                </div>
...
export default ShoulderRatingCard;