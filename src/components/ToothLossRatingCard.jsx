...
/**
 * Tooth Loss Rating Card Component
 * Shows tooth loss analysis and VA rating (DC 9913)
 */
const ToothLossRatingCard = ({ analysis, expanded, onToggle }) => {
              ...
              <div className="space-y-4 text-left">
                ...
                {criteria.definitions && Object.keys(criteria.definitions).length > 0 && (
                    <div>
                      ...
                      >
                        <span>📖</span>
                        <span>{showDefinitions ? 'Hide' : 'Show'} Tooth Loss Rating Definitions</span>
                      </button>
                ...
                <div className="bg-red-50 dark:bg-red-900/20 rounded-lg p-4 border-l-4 border-red-500">
                  <h4 className="font-medium text-red-900 dark:text-red-300 mb-2">
                    ⚠️ Critical: Tooth Loss Must Be Due to Bone Loss
                  </h4>
                  <ul className="space-y-2 text-sm text-red-800 dark:text-red-400">
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>VA only rates tooth loss if caused by bone loss from trauma, osteomyelitis, radiation, or disease</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Tooth loss from periodontal disease alone is NOT compensable</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Document the underlying bone/jaw condition causing tooth loss</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Higher rating if prosthesis does NOT restore chewing ability</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Count total missing teeth and document locations (anterior vs. posterior)</span>
                    </li>
                  </ul>
                </div>
...
export default ToothLossRatingCard;