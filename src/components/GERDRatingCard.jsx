...
/**
 * GERD Rating Card Component
 * Shows GERD symptom analysis and VA rating
 */
const GERDRatingCard = ({ analysis, expanded, onToggle }) => {
              ...
              <div className="space-y-4 text-left">
                ...
                {criteria.definitions && Object.keys(criteria.definitions).length > 0 && (
                    <div>
                      ...
                      >
                        <span>📖</span>
                        <span>{showDefinitions ? 'Hide' : 'Show'} GERD Rating Definitions</span>
                      </button>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border-l-4 border-blue-500">
                  <h4 className="font-medium text-blue-900 dark:text-blue-300 mb-2">
                    Important: GERD Documentation
                  </h4>
                  <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-400">
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Log heartburn (pyrosis) episodes - hallmark symptom</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Document regurgitation frequency and triggers</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>Note chest pain, especially substernal (behind breastbone)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>30% rating requires multiple symptoms persistently recurrent</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5">•</span>
                      <span>60% rating requires medical documentation of complications</span>
                    </li>
                  </ul>
                </div>
