              ...
              {metrics && (
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      {metrics.ivInfusionCount > 0 && (
                          <div className="bg-purple-50 dark:bg-purple-900/20 p-3 rounded-lg">
                            <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">
                              {metrics.ivInfusionCount}
                            </div>
                      ...
                      {metrics.oralSupplementationDays > 0 && (
                          <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg col-span-2">
                            <div className="text-2xl font-bold text-green-600 dark:text-green-400">
                              {metrics.oralSupplementationDays}
                            </div>
                            <div className="text-xs text-green-700 dark:text-green-300">
                              Days on Oral Iron Supplementation
                            </div>
                          </div>
                      )}
                    </div>
