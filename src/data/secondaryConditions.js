...
export const SECONDARY_CONDITIONS_MAP = {
  ...
  'tinnitus': {
    ...
    secondaryConditions: [
      ...
      },
      {
        ...
        category: 'mental-health',
        nexusStrength: 'moderate',
        notes: 'Chronic tinnitus causes significant psychological distress. Well-documented in medical literature that persistent tinnitus leads to clinical depression. File as secondary to tinnitus.',
      },
      {
        name: 'Anxiety Disorder',
        diagnosticCode: '9400',
  ...
  'backCondition': {
    ...
    secondaryConditions: [
      ...
      {
        name: 'Obesity (Intermediate Step)',
        diagnosticCode: '7717',
        category: 'endocrine',
        nexusStrength: 'moderate',
        notes: 'Reduced mobility from chronic back pain can lead to weight gain and obesity. Obesity then serves as an intermediate step connecting back condition to diabetes (DC 7913) or sleep apnea (DC 6847). Document the causal chain: SC back → reduced mobility → obesity → secondary condition.',
        intermediateStep: true,
      },
      {
        name: 'Hip Degeneration (Altered Gait)',
        diagnosticCode: '5252',
        category: 'musculoskeletal',
        nexusStrength: 'moderate',
        notes: 'Altered gait pattern from back pain causes abnormal loading of hip joints leading to degenerative changes over time.',
      },
    ],
  },
  ...
  'kneeCondition': {
    ...
    secondaryConditions: [
      ...
      {
        name: 'Shoulder Condition (Fall from Instability)',
        diagnosticCode: '5200-5203',
        category: 'musculoskeletal',
        nexusStrength: 'moderate',
        notes: '38 CFR §3.310 chain-of-events nexus: SC knee instability causes a fall, which directly causes shoulder injury resulting in chronic impairment. Document the specific fall event, the mechanism (knee gave out), and the resulting shoulder diagnosis. Buddy/lay statements from witnesses to the fall are especially valuable here.',
        chainOfEvents: true,
      },
      {
        name: 'Head/TBI Residuals (Fall from Instability)',
        diagnosticCode: '8045',
        category: 'neurological',
        nexusStrength: 'moderate',
        notes: '38 CFR §3.310 chain-of-events: SC knee instability → fall → head impact → TBI residuals. Requires documentation of the fall event and resulting diagnosis. Medical records from the ER or treating provider at time of injury are critical.',
        chainOfEvents: true,
      },
      {
        name: 'Obesity (Intermediate Step)',
        ...
        category: 'endocrine',
        nexusStrength: 'moderate',
        notes: 'Reduced mobility from chronic knee condition leads to weight gain. Obesity then serves as an intermediate step to diabetes (DC 7913) or sleep apnea (DC 6847). Per VA precedent, obesity can be a valid intermediate step when the causal chain is documented: SC knee → reduced mobility → obesity → secondary condition.',
        intermediateStep: true,
      },
    ],
  },
